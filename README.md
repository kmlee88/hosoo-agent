...
맥에서 매시 정각 자동 수집을 등록하려면 아래 설치 스크립트를 한 번 실행합니다.

```bash
scripts/install_reservation_launchd.sh
```

자동 수집은 매시 정각과 23:50에 실행되며, 실행 로그는 `logs/reservation-collector.log`에 남습니다.
